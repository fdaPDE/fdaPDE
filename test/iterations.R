...
boxplot(log(tLocA[,2]),log(tLocB[,2]),log(tLocC[,2]),log(tLocD[,1]), names=c('fdaPDE','mass lumping','lambda','block'),col=c('gray',2,3,4),ylab='log time')
 boxplot(log(tLocA[,3]),log(tLocB[,3]),log(tLocC[,3]),log(tLocD[,2]), names=c('fdaPDE','mass lumping','lambda','block'),col=c('gray',2,3,4),ylab='log time')
 boxplot(log(tLocA[,3]),log(tLocB[,3]),log(tLocC[,3]),log(tLocD[,3]), names=c('fdaPDE','mass lumping','lambda','block'),col=c('gray',2,3,4),ylab='log time')
 boxplot(log(tLocA[,4]),log(tLocB[,4]),log(tLocC[,4]),log(tLocD[,4]), names=c('fdaPDE','mass lumping','lambda','block'),col=c('gray',2,3,4),ylab='log time')

 boxplot((rmseLocA[,1]),(rmseLocB[,1]),(rmseLocC[,1]),(rmseLocD[,1]), names=c('fdaPDE','mass lumping','lambda','block'),col=c('gray',2,3,4),ylab='RMSE')
...
plot(seq(2.5,4,length.out = 5)[1:4],colMeans(rmseLocA),col=1,pch=19,xlab = 'minimum mesh angle', ylab='mean RMSE')#,ylim=c(min(colMeans(rmseMeshA)),max(colMeans(rmseMeshB))))
lines(seq(2.5,4,length.out = 5)[1:4],colMeans(rmseLocA),col=1,xlab = 'minimum mesh angle', ylab='mean RMSE')
points(seq(2.5,4,length.out = 5)[1:4],colMeans(rmseLocB),col=2,pch=4,xlab = 'minimum mesh angle', ylab='mean RMSE')
lines(seq(2.5,4,length.out = 5)[1:4],colMeans(rmseLocB),col=2,xlab = 'minimum mesh angle', ylab='mean RMSE')
points(seq(2.5,4,length.out = 5)[1:4],colMeans(rmseLocC),col=3,pch=1,xlab = 'minimum mesh angle', ylab='mean RMSE')
lines(seq(2.5,4,length.out = 5)[1:4],colMeans(rmseLocC),col=3,xlab = 'minimum mesh angle', ylab='mean RMSE')
points(seq(2.5,4,length.out = 5)[1:4],colMeans(rmseLocD),col=4,pch=4,xlab = 'minimum mesh angle', ylab='mean RMSE')
lines(seq(2.5,4,length.out = 5)[1:3],colMeans(rmseLocD[1:3]),col=4,xlab = 'minimum mesh angle', ylab='mean RMSE')
grid()
...
plot(ang,log(colMeans(tMeshA)),col=1,pch=19,xlab = 'minimum mesh angle', ylab='mean RMSE',ylim=c(min(colMeans(log(tMeshA))),max(colMeans(log(tMeshD)))))
lines(ang,log(colMeans(tMeshA)),col=1,xlab = 'minimum mesh angle', ylab='mean RMSE')
points(ang,log(colMeans(tMeshB)),col=2,pch=19,xlab = 'minimum mesh angle', ylab='mean RMSE')
lines(ang,log(colMeans(tMeshB)),col=2,xlab = 'minimum mesh angle', ylab='mean RMSE')
points(ang,log(colMeans(tMeshC)),col=3,pch=19,xlab = 'minimum mesh angle', ylab='mean RMSE')
lines(ang,log(colMeans(tMeshC)),col=3,xlab = 'minimum mesh angle', ylab='mean RMSE')
points(ang,log(colMeans(tMeshD[,1:4])),col=4,pch=19,xlab = 'minimum mesh angle', ylab='mean RMSE')
lines(ang,log(colMeans(tMeshD[,1:4])),col=4,xlab = 'minimum mesh angle', ylab='mean RMSE')
grid()
