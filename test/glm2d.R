...
boxplot(log(t3A$time),log(t3B$time),log(t3C$time), names=c('fdaPDE','mass lumping','lambda'),col=c('grey',2,3), ylab='log(time)')
boxplot(log(t4A$time),log(t4B$time),log(t4C$time), names=c('fdaPDE','mass lumping','lambda'),col=c('grey',2,3), ylab='log(time)')
