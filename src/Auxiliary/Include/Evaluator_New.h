#ifndef __EVALUATOR_NEW_H
#define __EVALUATOR_NEW_H
...
{
public:
    Evaluator_New(const MeshHandler<ORDER,mydim,ndim>& mesh): mesh_(mesh){};
...
typename std::enable_if<!isManifold,void>::type
Evaluator_New<ORDER, mydim, ndim>::eval(const RNumericMatrix &locations, const RNumericMatrix &coef, bool redundancy,
...
template<UInt ORDER,UInt mydim, UInt ndim>
void Evaluator_New<ORDER, mydim, ndim>::evalWithInfo(const RNumericMatrix &locations, const RNumericMatrix &coef,
...
template<UInt ORDER, UInt mydim, UInt ndim>
void Evaluator_New<ORDER, mydim, ndim>::integrate(const RIntegerMatrix &incidenceMatrix, const RNumericMatrix &coef,
