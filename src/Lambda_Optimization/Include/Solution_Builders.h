...
namespace Solution_Builders
{
        ...
        */
        ...
        static SEXP build_solution_plain_regression(const MatrixXr & solution, const output_Data & output, const MeshHandler<ORDER, mydim, ndim> & mesh, const InputHandler & regressionData, const MatrixXv & inference_Output, const InferenceData & inf_Data);
};
