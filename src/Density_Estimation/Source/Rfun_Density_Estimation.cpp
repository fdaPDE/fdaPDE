 ...
 UInt mydim=INTEGER(Rmydim)[0];
       ...
       std::string preprocess_method=CHAR(STRING_ELT(RpreprocessMethod, 0));
          ...
          if(order== 1 && mydim==2 && ndim==2)
            return(DE_skeleton<1, 2, 2>(Rdata, Rorder, Rfvec, RheatStep, RheatIter, Rlambda, Rnfolds, Rnsim, RstepProposals, Rtol1, Rtol2, Rprint, RnThreads_int, RnThreads_l, RnThreads_fold, Rmesh, Rsearch, step_method, direction_method, preprocess_method));
          else if(order== 2 && mydim==2 && ndim==2)
            return(DE_skeleton<2, 2, 2>(Rdata, Rorder, Rfvec, RheatStep, RheatIter, Rlambda, Rnfolds, Rnsim, RstepProposals, Rtol1, Rtol2, Rprint, RnThreads_int, RnThreads_l, RnThreads_fold, Rmesh, Rsearch, step_method, direction_method, preprocess_method));
          else if(order== 1 && mydim==2 && ndim==3)
            return(DE_skeleton<1, 2, 3>(Rdata, Rorder, Rfvec, RheatStep, RheatIter, Rlambda, Rnfolds, Rnsim, RstepProposals, Rtol1, Rtol2, Rprint, RnThreads_int, RnThreads_l, RnThreads_fold, Rmesh, Rsearch, step_method, direction_method, preprocess_method));
          else if(order== 2 && mydim==2 && ndim==3)
            return(DE_skeleton<2, 2, 3>(Rdata, Rorder, Rfvec, RheatStep, RheatIter, Rlambda, Rnfolds, Rnsim, RstepProposals, Rtol1, Rtol2, Rprint, RnThreads_int, RnThreads_l, RnThreads_fold, Rmesh, Rsearch, step_method, direction_method, preprocess_method));
          else if(order == 1 && mydim==3 && ndim==3)
            return(DE_skeleton<1, 3, 3>(Rdata, Rorder, Rfvec, RheatStep, RheatIter, Rlambda, Rnfolds, Rnsim, RstepProposals, Rtol1, Rtol2, Rprint, RnThreads_int, RnThreads_l, RnThreads_fold, Rmesh, Rsearch, step_method, direction_method, preprocess_method));
          else if(order == 2 && mydim==3 && ndim==3)
            return(DE_skeleton<2, 3, 3>(Rdata, Rorder, Rfvec, RheatStep, RheatIter, Rlambda, Rnfolds, Rnsim, RstepProposals, Rtol1, Rtol2, Rprint, RnThreads_int, RnThreads_l, RnThreads_fold, Rmesh, Rsearch, step_method, direction_method, preprocess_method));
	  else if(order == 1 && mydim==1 && ndim==2)
            return(DE_skeleton<1, 1, 2>(Rdata, Rorder, Rfvec, RheatStep, RheatIter, Rlambda, Rnfolds, Rnsim, RstepProposals, Rtol1, Rtol2, Rprint, RnThreads_int, RnThreads_l, RnThreads_fold, Rmesh, Rsearch, step_method, direction_method, preprocess_method));
          else if(order == 2 && mydim==1 && ndim==2)
            return(DE_skeleton<2, 1, 2>(Rdata, Rorder, Rfvec, RheatStep, RheatIter, Rlambda, Rnfolds, Rnsim, RstepProposals, Rtol1, Rtol2, Rprint, RnThreads_int, RnThreads_l, RnThreads_fold, Rmesh, Rsearch, step_method, direction_method, preprocess_method));
        ...
        SEXP RnThreads_fold, SEXP Rsearch, SEXP Rinit, SEXP Rinit_fold)
{
 ...
 UInt mydim=INTEGER(Rmydim)[0];
       ...
       std::string init=CHAR(STRING_ELT(Rinit, 0));
          ...
          if(order== 1 && mydim==2 && ndim==2)
            return(DE_init_skeleton<1, 2, 2>(Rdata, Rorder, Rfvec, RheatStep, RheatIter, Rlambda, Rnfolds, Rnsim, RstepProposals, Rtol1, Rtol2, Rprint, RnThreads_int, RnThreads_l, RnThreads_fold, Rmesh, Rsearch, init, init_fold));
          else if(order== 2 && mydim==2 && ndim==2)
            return(DE_init_skeleton<2, 2, 2>(Rdata, Rorder, Rfvec, RheatStep, RheatIter, Rlambda, Rnfolds, Rnsim, RstepProposals, Rtol1, Rtol2, Rprint, RnThreads_int, RnThreads_l, RnThreads_fold, Rmesh, Rsearch, init, init_fold));
          else if(order== 1 && mydim==2 && ndim==3)
            return(DE_init_skeleton<1, 2, 3>(Rdata, Rorder, Rfvec, RheatStep, RheatIter, Rlambda, Rnfolds, Rnsim, RstepProposals, Rtol1, Rtol2, Rprint, RnThreads_int, RnThreads_l, RnThreads_fold, Rmesh, Rsearch, init, init_fold));
          else if(order== 2 && mydim==2 && ndim==3)
            return(DE_init_skeleton<2, 2, 3>(Rdata, Rorder, Rfvec, RheatStep, RheatIter, Rlambda, Rnfolds, Rnsim, RstepProposals, Rtol1, Rtol2, Rprint, RnThreads_int, RnThreads_l, RnThreads_fold, Rmesh, Rsearch, init, init_fold));
          else if(order == 1 && mydim==3 && ndim==3)
            return(DE_init_skeleton<1, 3, 3>(Rdata, Rorder, Rfvec, RheatStep, RheatIter, Rlambda, Rnfolds, Rnsim, RstepProposals, Rtol1, Rtol2, Rprint, RnThreads_int, RnThreads_l, RnThreads_fold, Rmesh, Rsearch, init, init_fold));
          else if(order == 2 && mydim==3 && ndim==3)
            return(DE_init_skeleton<2, 3, 3>(Rdata, Rorder, Rfvec, RheatStep, RheatIter, Rlambda, Rnfolds, Rnsim, RstepProposals, Rtol1, Rtol2, Rprint, RnThreads_int, RnThreads_l, RnThreads_fold, Rmesh, Rsearch, init, init_fold));
	  else if(order == 1 && mydim==1 && ndim==2)
            return(DE_init_skeleton<1, 1, 2>(Rdata, Rorder, Rfvec, RheatStep, RheatIter, Rlambda, Rnfolds, Rnsim, RstepProposals, Rtol1, Rtol2, Rprint, RnThreads_int, RnThreads_l, RnThreads_fold, Rmesh, Rsearch, init, init_fold));
          else if(order == 2 && mydim==1 && ndim==2)
            return(DE_init_skeleton<2, 1, 2>(Rdata, Rorder, Rfvec, RheatStep, RheatIter, Rlambda, Rnfolds, Rnsim, RstepProposals, Rtol1, Rtol2, Rprint, RnThreads_int, RnThreads_l, RnThreads_fold, Rmesh, Rsearch, init, init_fold));
