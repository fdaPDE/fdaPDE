...
public:
  ...
  */
  static std::unique_ptr<Solver_Base<InputHandler>> create_inference_solver_method(const std::string & implementation_type_, std::unique_ptr<Inverse_Base> inverter_, const Inference_Carrier<InputHandler> & inf_car_)
  {
