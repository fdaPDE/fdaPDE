...
public:
  ...
  Eigen_Sign_Flip_Solver(Eigen_Sign_Flip_Solver && rhs):inverter(std::move(rhs.inverter), inf_car(rhs.inf_car), Partial_res_H0(std::move(rhs.Partial_res_H0)), B(std::move(rhs.B)), Lambda(std::move(rhs.Lambda)), is_Lambda_computed(rhs.is_Lambda_computed){}; //Definition of the move constructor
