...
class InferenceData
{
	...
	public:
  	//Constructors
		...
		inline void set_enhanced_inference(const std::vector<bool> & enhanced_Inference_){enhanced_Inference = enhanced_Inference_;}; //!< Setter for enhanced_Inference \param enhanced_Inference_ new enhanced_Inference
  	...
  	//Getters
		...
		inline std::vector<bool> get_enhanced_inference() const{return this->enhanced_Inference;};		        //!< Getter for enhanced_Inference \return enhanced_Inference
