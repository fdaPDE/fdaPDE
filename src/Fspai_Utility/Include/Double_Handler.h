...
#ifndef DOUBLE_HANDLER_H_
#define DOUBLE_HANDLER_H_
...
///     \brief Double matrix field interface
///
///     Double matrix interface.
//////////////////////////////////////////
class Double_Handler : public Type_Base_Handler
{
    public:
        /////////////////////////////////////////////////////////
        ///     \brief Constructor
        ...
        ///     \param hash_size size of the hash table to be
    	///						 used.
        /////////////////////////////////////////////////////////
        Double_Handler
    ...
    protected:
        ...
        Fspai_Base<double>*     Fspai_base_algorithm;

        /// PCG solver pointer
        PCG<double>*            solver;
};

#endif /* DOUBLE_HANDLER_H_ */
