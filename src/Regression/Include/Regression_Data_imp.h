...
RegressionDataGAM<RegressionHandler>::RegressionDataGAM(
    ...
    : RegressionData(Rlocations, RbaryLocations, Rtime_locations, Robservations,
                     ...
                     Rflag_parabolic, Rflag_iterative, Rmax_num_iteration, Rthreshold, Ric, Rsearch) {
...
RegressionDataGAM<RegressionHandler>::RegressionDataGAM(
    ...
    SEXP RarealDataAvg, SEXP Rflag_mass, SEXP Rflag_parabolic,SEXP Rflag_iterative, SEXP Rmax_num_iteration, SEXP Rthreshold, SEXP Ric,
    SEXP Rsearch, SEXP Rmax_num_iteration_pirls, SEXP Rthreshold_pirls)
...
RegressionDataGAM<RegressionHandler>::RegressionDataGAM(
    ...
    : RegressionDataEllipticSpaceVarying(
          ...
          RincidenceMatrix, RarealDataAvg, Rflag_mass, Rflag_parabolic, Rflag_iterative, Rmax_num_iteration_pirls, Rthreshold_pirls, Ric,
          Rsearch) {
    max_num_iterations_ = INTEGER(Rmax_num_iteration_pirls)[0];
    threshold_ = REAL(Rthreshold_pirls)[0];
    initialObservations_ = this->observations_;
