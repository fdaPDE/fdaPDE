...
extern "C"
{
  ...
  */
  SEXP regression_PDE_space_varying(SEXP Rlocations, SEXP RbaryLocations, SEXP Robservations, SEXP Rmesh, SEXP Rorder, SEXP Rmydim, SEXP Rndim,
				    ...
				    SEXP Rsearch, SEXP Roptim, SEXP Rlambda, SEXP Rnrealizations, SEXP Rseed, SEXP RDOF_matrix, SEXP Rtune, SEXP Rsct, SEXP RtestType, SEXP RintervalType, SEXP RimplementationType, SEXP RcomponentType, SEXP RexactInference,
				    ...
				    SEXP RinferenceQuantile, SEXP RinferenceAlpha, SEXP RinferenceFlip, SEXP RinferenceTolFspai, SEXP RinferenceSeed, SEXP RinferenceDefined)
  {
    ...
    InferenceData inferenceData(RtestType, RintervalType, RimplementationType, RcomponentType, RexactInference, RlocsInference, RlocsindexInference, Rlocsarenodes, RcoeffInference, Rbeta0, Rf0eval, RscalingFactorInference, RfvarInference, RinferenceQuantile, RinferenceAlpha, RinferenceFlip, RinferenceTolFspai, RinferenceFlip, RinferenceDefined);
  ...
  */
					 ...
					 SEXP Rflag_mass, SEXP Rflag_parabolic,SEXP Rflag_iterative, SEXP Rmax_num_iteration, SEXP Rtreshold, SEXP Ric, SEXP Rsearch, SEXP Roptim, SEXP Rlambda_S, SEXP Rlambda_T, SEXP Rnrealizations, SEXP Rseed, SEXP RDOF_matrix, SEXP Rtune, SEXP Rsct, SEXP RtestType, SEXP RintervalType, SEXP RimplementationType,  SEXP RcomponentType, SEXP RexactInference, SEXP RlocsInference, SEXP RlocsindexInference, SEXP Rlocsarenodes, SEXP RtimeLocsInf ,SEXP RcoeffInference, SEXP Rbeta0, SEXP Rf0eval, SEXP RscalingFactor, SEXP RfvarInference, SEXP RinferenceQuantile,SEXP RinferenceAlpha, SEXP RinferenceFlip, SEXP RinferenceTolFspai, SEXP RinferenceSeed,SEXP RinferenceDefined)
  {
    ...
    InferenceData inferenceData(RtestType, RintervalType, RimplementationType, RcomponentType, RexactInference, RlocsInference, RlocsindexInference, Rlocsarenodes, RtimeLocsInf, RcoeffInference, Rbeta0, Rf0eval, RscalingFactor, RfvarInference, RinferenceQuantile, RinferenceAlpha, RinferenceFlip, RinferenceTolFspai,RinferenceSeed, RinferenceDefined);

    UInt mydim = INTEGER(Rmydim)[0];
    UInt ndim = INTEGER(Rndim)[0];

    if(regressionData.getOrder() == 1 && ndim==2)
      return(regression_skeleton_time<RegressionDataEllipticSpaceVarying, 1, 2, 2>(regressionData, optimizationData, inferenceData, Rmesh, Rmesh_time));
    else if(regressionData.getOrder() == 2 && ndim==2)
      return(regression_skeleton_time<RegressionDataEllipticSpaceVarying, 2, 2, 2>(regressionData, optimizationData, inferenceData, Rmesh, Rmesh_time));
    // else if(regressionData.getOrder() == 1 && mydim==2 && ndim==3)
    //         return(regression_skeleton_time<RegressionDataEllipticSpaceVarying, 1, 2, 3>(regressionData, optimizationData, inferenceData, Rmesh, Rmesh_time));
    // else if(regressionData.getOrder() == 2 && mydim==2 && ndim==3)
    //         return(regression_skeleton_time<RegressionDataEllipticSpaceVarying, 2, 2, 3>(regressionData, optimizationData, inferenceData, Rmesh, Rmesh_time));
    else if(regressionData.getOrder() == 1 && mydim==3 && ndim==3)
      return(regression_skeleton_time<RegressionDataEllipticSpaceVarying, 1, 3, 3>(regressionData, optimizationData, inferenceData, Rmesh, Rmesh_time));
    else if(regressionData.getOrder() == 2 && mydim==3 && ndim==3)
      return(regression_skeleton_time<RegressionDataEllipticSpaceVarying, 2, 3, 3>(regressionData, optimizationData, inferenceData, Rmesh, Rmesh_time));
  ...
  */
				  ...
				  SEXP RDOF_matrix, SEXP Rtune, SEXP Rsct)
  {
    ...
    if(regressionData.getOrder() == 1 && mydim == 2 && ndim==2)
      return(GAM_skeleton_time<GAMDataEllipticSpaceVarying, 1, 2, 2>(regressionData, optimizationData, Rmesh, Rmesh_time, Rmu0, family, RscaleParam));
    else if(regressionData.getOrder() == 2 && mydim == 2 && ndim==2)
      return(GAM_skeleton_time<GAMDataEllipticSpaceVarying, 2, 2, 2>(regressionData, optimizationData, Rmesh, Rmesh_time, Rmu0, family, RscaleParam));
    else if(regressionData.getOrder() == 1 && mydim == 3 && ndim==3)
      return(GAM_skeleton_time<GAMDataEllipticSpaceVarying, 1, 3, 3>(regressionData, optimizationData, Rmesh, Rmesh_time, Rmu0, family, RscaleParam));
    else if(regressionData.getOrder() == 2 && mydim == 3 && ndim==3)
      return(GAM_skeleton_time<GAMDataEllipticSpaceVarying, 2, 3, 3>(regressionData, optimizationData, Rmesh, Rmesh_time, Rmu0, family, RscaleParam));
