...
my_density <- function(data, mesh, PHI, FEMbasis, K0, K1, lambda, epsil, initialization, ns, Nesterov = FALSE) {
  ...
  return(list(density=cvec, gradient=gradient, GGG=GGG, int_tot=int_tot))
