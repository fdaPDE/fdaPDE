...
if(!dir.exists(test_path("../data/tGSR-PDE/test_24"))){
  dir.create(test_path("../data/tGSR-PDE/test_24"))  
...
invisible(capture.output(sol_ref <- smooth.FEM.time(observations=response,
                              ...
                              FLAG_PARABOLIC = TRUE)))
save(sol_ref, file=paste0(foldername,"/test_24_1.RData"))
...
save(sol_ref, file=paste0(foldername,"/test_24_2.RData"))
}
