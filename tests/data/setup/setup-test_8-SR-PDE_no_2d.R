...
save(sol_ref, file=paste0(foldername,"/test_8_1.RData"))
...
save(sol_ref, file=paste0(foldername,"/test_8_2.RData"))
...
save(sol_ref, file=paste0(foldername,"/test_8_3.RData"))
...
save(sol_ref, file=paste0(foldername,"/test_8_4.RData"))
