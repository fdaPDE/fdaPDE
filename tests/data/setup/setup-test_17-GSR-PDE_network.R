...
if(!dir.exists(test_path("../data/GSR-PDE/test_17"))){
  dir.create(test_path("../data/GSR-PDE/test_17"))  
...
invisible(capture.output(sol_ref <- smooth.FEM(location = NULL, observations = as.numeric(response), FEMbasis =FEMbasis, covariates = desmat,
                        ...
                        lambda = lambda)))
save(sol_ref, file=paste0(foldername,"/test_17_1.RData"))
...
save(sol_ref, file=paste0(foldername,"/test_17_2.RData"))
}
