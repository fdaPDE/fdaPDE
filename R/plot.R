...
#' Plot a mesh.1D object
#'
#' @param x A \code{mesh.1D} object defining the triangular mesh, as generated by \code{create.mesh.1D}
#' or \code{refine.mesh.1D}.
#' @param ... Arguments representing graphical options to be passed to \link[graphics]{par}.
#' @description Plot a mesh.1D object, generated by \code{create.mesh.1D} or \code{refine.mesh.1D}.
#' @name plot.mesh.1D

#' @usage \method{plot}{mesh.1D}(x, ...)
#' @export
