...
class Preprocess{
  protected:
    ...
    std::unique_ptr<DensityInitialization<Integrator, Integrator_noPoly, ORDER, mydim, ndim>> densityInit_;
  ...
  public:
    //! A constructor.
    Preprocess(const DataProblem<Integrator, Integrator_noPoly, ORDER, mydim, ndim>& dp,
...
template<typename Integrator, typename Integrator_noPoly, UInt ORDER, UInt mydim, UInt ndim>
class NoCrossValidation : public Preprocess<Integrator, Integrator_noPoly, ORDER, mydim, ndim>{
  public:
    //! A constructor
    NoCrossValidation(const DataProblem<Integrator, Integrator_noPoly, ORDER, mydim, ndim>& dp,
      const FunctionalProblem<Integrator, Integrator_noPoly, ORDER, mydim, ndim>& fp):
      Preprocess<Integrator, Integrator_noPoly, ORDER, mydim, ndim>(dp, fp){};
...
*/
template<typename Integrator, typename Integrator_noPoly, UInt ORDER, UInt mydim, UInt ndim>
class CrossValidation : public Preprocess<Integrator, Integrator_noPoly, ORDER, mydim, ndim>{
  protected:
  ...
  public:
    //! A constructor.
    CrossValidation(const DataProblem<Integrator, Integrator_noPoly, ORDER, mydim, ndim>& dp,
       const FunctionalProblem<Integrator, Integrator_noPoly, ORDER, mydim, ndim>& fp,
...
template<typename Integrator, typename Integrator_noPoly, UInt ORDER, UInt mydim, UInt ndim>
class SimplifiedCrossValidation : public CrossValidation<Integrator, Integrator_noPoly, ORDER, mydim, ndim>{
  private:
  ...
  public:
    ...
    SimplifiedCrossValidation(const DataProblem<Integrator, Integrator_noPoly, ORDER, mydim, ndim>& dp,
       const FunctionalProblem<Integrator, Integrator_noPoly, ORDER, mydim, ndim>& fp,
       std::shared_ptr<MinimizationAlgorithm<Integrator, Integrator_noPoly, ORDER, mydim, ndim>> ma):
...
template<typename Integrator, typename Integrator_noPoly, UInt ORDER, UInt mydim, UInt ndim>
class RightCrossValidation : public CrossValidation<Integrator, Integrator_noPoly, ORDER, mydim, ndim>{
  private:
